...
export let state = [Math.PI, Math.PI, 0, 0]; // Initial state: (angle1, angle2, angularVelocity1, angularVelocity2)
...
export let limit = 500 * speedFactor; // Number of positions to calculate
